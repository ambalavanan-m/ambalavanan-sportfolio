...
import { X, Github, Linkedin, Twitter, Instagram, Share2, HelpCircle } from 'lucide-react';
            ...
            >
              ...
              <div className="bg-text p-6 text-white flex justify-between items-center shrink-0">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h2 className="font-bold text-lg leading-tight">Connectivity Hub</h2>
                    <p className="text-[10px] uppercase tracking-[0.2em] font-bold text-primary animate-pulse">Social Systems Online</p>
                  </div>
                </div>
